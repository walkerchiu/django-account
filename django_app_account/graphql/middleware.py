...
from django_app_account.graphql.loaders import generate_loader_for_one_to_one


class DashboardLoaders:
    def __init__(self):
        from django_app_account.graphql.dashboard.types.profile import ProfileNode
